...
<br><br><br><br><br><br><br><br><br><br><br>
   <a href="ratings.php"> <button class="button">Rating</button></a>&nbsp;
   <a href="genre.php"><button class="button">Genre</button></a>&nbsp;
   <a href="review.php"> <button class="button">Review</button></a>&nbsp;
   <a href="date.php"> <button class="button">Date</button></a>&nbsp;
   <a href="home.php"> <button class="button">BACK</button></a>
  </body>
</html>
