...
<tr>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="5"> <th>MOVIE NAME</th></font></br>
        ...
        <?php
            ...
            $actorquery = "Select MD.MOVIE_NAME from movie_details MD,movie_ratings MR where MD.MOVIE_ID=MR.MOVIE_ID AND RATING IN(SELECT RATING From movie_ratings where rating between 4 and 6);";
